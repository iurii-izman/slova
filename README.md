...
- 📝 **Rich editing** — Edit transcripts inline with real-time preview
- 💾 **Multiple export formats** — TXT, SRT, JSON with timestamps
- ⚙️ **Audio preprocessing** — Automatic noise reduction and optimization
- 🔄 **Smart retry logic** — Exponential backoff with automatic retry
- 📊 **Progress tracking** — Real-time upload and transcription progress
- 🎯 **Deduplication** — Cache by file hash, skip already processed files

🚧 **In Development:**
- Configurable parallelism limits
- Timestamp synchronization for SRT export
- Optional postprocessing with Groq Llama
- ffmpeg fallback chunking for large files
